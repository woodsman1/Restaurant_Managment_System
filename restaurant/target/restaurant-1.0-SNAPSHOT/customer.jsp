<%-- 
    Document   : customer
    Created on : Nov 5, 2020, 8:18:24 PM
    Author     : Mohit
--%>
...
<body>
	...
	<!-- End All Pages -->
        ...
        <form action="SearchOrder" method="post">
            <div class="container">
                <input type="text" id="orderid" name="order_id" placeholder="Enter OrderID">
        ...
        <table class="table" id="table-custom">
                ...
                <%
                   for (int i = 0; i < v1.size(); i++){
                    ...
                    <tr>
                        ...
                        <td><%=name%></td>
                        <td>$<%=price%></td>
                        <td><input type="number" id="quantity" name="<%=id%>" min="0" max="5" value="0"></td>
                     </tr>
                <%    
                  } 
                %>
			...
			<button class="btn btn-common"  type="submit">Order</button>
