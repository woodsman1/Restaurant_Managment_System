<%-- 
    ...
    Created on : Nov 6, 2020, 4:34:47 PM
    Author     : Mohit
--%>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link" href="customer.jsp">Menu</a></li>
								...
								<div class="col-md-6">
									...
									<div class="col-md-12">
										<div class="form-group">
											<input id="input_date" class="datepicker picker__input form-control" name="date" type="text" value="" equired data-error="Please enter Date" placeholder="Select Date">
											<div class="help-block with-errors"></div>
										</div>                                 
									</div>
									<div class="col-md-12">
										<div class="form-group">
											<input id="input_time" class="time form-control picker__input" name="time" required data-error="Please enter time" placeholder="Select Time">
											<div class="help-block with-errors"></div>
										</div>                                 
									</div>
									<div class="col-md-12">
										<div class="form-group">
											<select class="custom-select d-block form-control" id="person" required data-error="Please select Person", name="person_number">
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<div class="help-block with-errors"></div>
                                                                        ...
                                                                        <div class="col-md-12">
										<div class="form-group">
											<input type="text" placeholder="Duration in Hour's" id="phone" class="form-control" name="duration" required data-error="Please enter the Duration">
											<div class="help-block with-errors"></div>
										</div> 
									</div>
								</div>
